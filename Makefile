...
# knit final report
docs/FinalReport_milestone03.pdf docs/FinalReport_milestone03.html : scripts/knit.R net_education_plot.png net_work_hours_plot.png linear-regression_plot.png processed_DL_datafile docs/FinalReport_milestone03.Rmd
