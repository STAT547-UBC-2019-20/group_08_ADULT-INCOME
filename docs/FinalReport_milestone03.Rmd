...
```{r net-gain-education, out.width='75%', fig.align='center', fig.cap='Figure 1: Boxplot of annual net capital gain across education levels'}
...
```{r net-race-gender, out.width='75%', fig.align='center', fig.cap='Figure 2: Violin plot of annual net capital gain by ethnicity and sex'}
...
```{r work-hours-plot, out.width='75%', fig.align='center', fig.cap='Figure 3: Plot of annual net capital gain by hours worked per week'}
...
```{r age-hours, out.width='75%', fig.align='center', fig.cap="Figure 4: Hours worked per week by age where plot 'A' shows the full dataset and plot 'B' shows a more linear section of filtered data (for workers under 30)"}
p1 <- dat %>% 
...
```{r age-hrs-plot, out.width='75%', fig.align='center', fig.cap='Figure 5: Plot of linear regression model data for hours worked by those under age 30'}
