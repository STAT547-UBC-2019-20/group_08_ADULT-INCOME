...
read_csv(url("https://raw.githubusercontent.com/STAT547-UBC-2019-20/group_08_ADULT-INCOME/master/data/variable_summary.csv"), 
         col_names = TRUE) %>% 
...
dat <- read.table(here("data", "downloaded_datafile"), sep = ",", header = FALSE,
...
```{r age-hrs-plot, out.width='75%', fig.align='center', fig.cap='Figure 5: Plot of linear regression model data for hours worked by those under age 30', echo = F}
